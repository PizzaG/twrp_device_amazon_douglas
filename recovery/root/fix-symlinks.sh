...
REAL_LK2=`readlink -f /dev/block/platform/mtk-msdc.0/by-name/lk2`
...
rm /dev/block/platform/mtk-msdc.0/by-name/lk2
...
ln -s $REAL_LK2 /dev/block/platform/mtk-msdc.0/by-name/lk2_real
...
ln -s /dev/null /dev/block/platform/mtk-msdc.0/by-name/lk2
