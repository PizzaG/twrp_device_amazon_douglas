...
BOARD_RAMDISK_OFFSET := 0x03408000
...
# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 13512704 # This is the maximum known partition size, but it can be higher, so we just omit it
